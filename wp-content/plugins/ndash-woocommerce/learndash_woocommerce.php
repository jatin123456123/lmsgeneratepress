...
define( 'LEARNDASH_WOOCOMMERCE_VERSION', '1.9.8.1' );
...
class Learndash_WooCommerce {
	...
	public static function add_front_scripts() {
		wp_enqueue_script( 'ld_wc_front', plugins_url( '/front.js', __FILE__ ), array( 'jquery' ), LEARNDASH_WOOCOMMERCE_VERSION, true );
	}
